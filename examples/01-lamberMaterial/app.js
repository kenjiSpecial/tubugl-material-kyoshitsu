...
const lamberVertexShaderSrc = require('../../src/lamberMaterial/shader-vert.glsl');
const lamberFragmentShaderSrc = require('../../src/lamberMaterial/shader-frag.glsl');
	...
	_makeSphere() {
		...
		this._shapes.push(
			new CustomSphereCollection(
				this.gl,
				{
					vertexShaderSrc: lamberVertexShaderSrc,
					fragmentShaderSrc: lamberFragmentShaderSrc
				},
				side,
				15,
				15
